...
function renderConclusion() {
	...
	conclusionContainer.innerHTML = `
	  ...
	  <p>Мы сравнили семь крупных городов России по важным критериям — стоимости жизни, здравоохранению, образованию, экономике, инфраструктуре и экологии. На сайте представлены карточки с основными данными по каждому городу, таблицы и графики, которые показывают, как города отличаются друг от друга.</p>
